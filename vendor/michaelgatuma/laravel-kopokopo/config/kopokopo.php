...
return [
    ...
    */
    ...
    # This is the application id acquired after you create an Authorization application on the kopokopo dashboard
    // 'client_id' => env('KOPOKOPO_CLIENT_ID', '-q66i2VsWmSPx1N7G-kUdlWp5-vA-duMj5t_5ujE7Ak'),

    # The kopokopo application client secret
    // 'client_secret' => env('KOPOKOPO_CLIENT_SECRET', 'EIMEi2wMTaDSyFHs5GAvCKfT6VUiQUPjY-MJpKWAOXA'),

    # The kopokopo application api key
    // 'api_key' => env('KOPOKOPO_API_KEY', '8bGXvtrij8b-NWHSnZHByEZpolikC5E6qBuW5GKt0dg'),
