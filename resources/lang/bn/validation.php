...
return [
  ...
  'alpha_dash' => ' :attribute-এ শুধুমাত্র অক্ষর, সংখ্যা, ড্যাশ এবং আন্ডারস্কোর থাকতে পারে।',
  'alpha_num' => ' :attribute-এ শুধুমাত্র অক্ষর এবং সংখ্যা থাকতে পারে।',
  ...
  'between' => [
    ...
    'array' => ' :attribute এর মধ্যে অবশ্যই :min এবং :max আইটেম থাকতে হবে।',
  ],
  ...
  'gt' => [
    ...
    'array' => ' :attribute-এ অবশ্যই :value-এর বেশি আইটেম থাকতে হবে।',
  ],
  'gte' => [
    'numeric' => ' :attribute অবশ্যই :value এর চেয়ে বড় বা সমান হতে হবে।',
    'file' => ' :attribute অবশ্যই :value কিলোবাইটের বেশি বা সমান হতে হবে।',
  ...
  'lte' => [
    ...
    'array' => ' :attribute-এ অবশ্যই :value-এর বেশি আইটেম থাকবে না।',
  ],
  'max' => [
    'numeric' => ' :attribute :max এর বেশি নাও হতে পারে।',
    'file' => ' :attribute :max কিলোবাইটের বেশি নাও হতে পারে।',
    'string' => ' :attribute :max অক্ষরের বেশি নাও হতে পারে।',
  ...
  'required_if' => ' :other :value হলে :attribute ক্ষেত্র প্রয়োজন।',
  'required_unless' => ' :attribute ক্ষেত্র আবশ্যক যদি না :other :values তে থাকে।',
  'required_with' => ' :values উপস্থিত থাকলে :attribute ক্ষেত্রটি প্রয়োজন।',
  'required_with_all' => ' :values উপস্থিত থাকলে :attribute ক্ষেত্রের প্রয়োজন হয়।',
  'required_without' => ' :values উপস্থিত না থাকলে :attribute ক্ষেত্রটি প্রয়োজনীয়।',
  'required_without_all' => ' :attribute ক্ষেত্রটি প্রয়োজন হয় যখন :values এর কোনোটিই উপস্থিত থাকে না।',
  'same' => ' :attribute এবং :other অবশ্যই মিলবে।',
  'size' => [
    'numeric' => ' :attribute অবশ্যই :size হবে।',
