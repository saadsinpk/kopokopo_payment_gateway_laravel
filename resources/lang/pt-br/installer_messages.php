...
return [
  ...
  'environment' => [
    'menu' => [
      ...
      'desc' => 'Selecione como deseja configurar o arquivo <code>.env</code> de aplicativos.',
    ...
    'wizard' => [
      ...
      'title' => 'Assistente de <code>.env</code> guiado',
      'tabs' => [
  ...
  'final' => [
    ...
    'migration' => 'Saída do Console de Migração e Semente:',
